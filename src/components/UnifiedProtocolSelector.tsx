...
export const PROTOCOLS_LIST: ProtocolOption[] = [
  {
    id: 'auto',
    name: 'الوضع التلقائي الذكي الشامل (Auto Multi-Stage)',
    badge: 'موصى به لجميع السيارات',
    badgeColor: 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30',
    desc: 'يجرب تلقائياً بالتسلسل: الجلسة الرسمية ← محرك r.sh المستقل ← واجهة الشاشة ← مجلد Download حتى ينجح التثبيت 100%.',
    recommendedFor: 'الخيار الأفضل والأضمن لأي شاشة سيارة',
    icon: <Sparkles className="w-4 h-4 text-emerald-400" />
  },
  {
    id: 'jetour_official',
    name: 'مثبت Jetour الرسمي (PackageInstaller Session)',
    badge: 'المسار الرسمي',
    badgeColor: 'bg-cyan-500/15 text-cyan-300 border-cyan-500/30',
    desc: 'إنشاء جلسة بث رسمية عبر PackageInstaller في نظام أندرويد مع إتاحة تأكيد التثبيت على شاشة السيارة.',
    recommendedFor: 'شاشات Jetour و Chery المحدثة رسمياً',
    icon: <ShieldCheck className="w-4 h-4 text-cyan-400" />
  },
  {
    id: 'jetour_helper',
    name: 'محرك r.sh و GtInstall المستقل (GarageTool Engine)',
    badge: 'خاص بجيتور T2',
    badgeColor: 'bg-indigo-500/15 text-indigo-300 border-indigo-500/30',
    desc: 'تجاوز فلاتر Shell عبر تشغيل app_process و dex مخصص مباشرة من الذاكرة المؤقتة /data/local/tmp.',
    recommendedFor: 'شاشات جيتور T2 المقفلة أمنياً من الوكالة',
    icon: <Zap className="w-4 h-4 text-indigo-400" />
  },
  {
    id: 'package_installer_ui',
    name: 'واجهة مثبت النظام الرسمية مع النقر التلقائي (UI Touch & Click)',
    badge: 'نقر تلقائي',
    badgeColor: 'bg-amber-500/15 text-amber-300 border-amber-500/30',
    desc: 'فتح واجهة تثبيت أندرويد الرسمية وإرسال نقرات فورية على زر [تثبيت/Install] عبر إحداثيات wm size ومفاتيح DPAD.',
    recommendedFor: 'تخطي حظر SecurityException بالكامل',
    icon: <Tv className="w-4 h-4 text-amber-400" />
  },
  {
    id: 'restriction_annihilator',
    name: 'ناسف قيود النظام والمستخدمين (User Restrictions Annihilator)',
    badge: 'كسر القيود',
    badgeColor: 'bg-rose-500/15 text-rose-300 border-rose-500/30',
    desc: 'إلغاء قيود DISALLOW_INSTALL_APPS للمستخدمين 0 و 10، وتثبيت الحزمة قسرياً مع تفعيلها لكافة واجهات السيارة.',
    recommendedFor: 'حالات رفض المستخدمين الفرعيين وقيود الأمان',
    icon: <Flame className="w-4 h-4 text-rose-400" />
  },
  {
    id: 'spoofed_installer',
    name: 'جلسة التثبيت بالهوية الموثوقة (-i com.android.vending)',
    badge: 'هوية متجر جوجل',
    badgeColor: 'bg-purple-500/15 text-purple-300 border-purple-500/30',
    desc: 'تثبيت الحزمة بانتحال هوية متجر Play Store المعتمد لدى حماية السيارة لتجاوز فحص المصادر المجهولة.',
    recommendedFor: 'الشاشات التي تتطلب تطبيقات من متجر معتمد',
    icon: <Layers className="w-4 h-4 text-purple-400" />
  },
  {
    id: 'broadcast_intent',
    name: 'حاقن أوامر وبث النظام (Desay SV / Chery Broadcast)',
    badge: 'أوامر النظام',
    badgeColor: 'bg-teal-500/15 text-teal-300 border-teal-500/30',
    desc: 'إرسال بث نظام مباشر وإشارات Intent لمستقبلات تثبيت المصنع في سيارات Desay SV وشاشات شيري وجيتور.',
    recommendedFor: 'الأنظمة التي تدعم التثبيت عبر بث Intent',
    icon: <Radio className="w-4 h-4 text-teal-400" />
  },
  {
    id: 'car_download_staging',
    name: 'إيداع مجلد التحميلات ومدير الملفات (/sdcard/Download)',
    badge: 'تثبيت يدوي موثوق',
    badgeColor: 'bg-blue-500/15 text-blue-300 border-blue-500/30',
    desc: 'نقل الحزمة إلى مجلد Download بشاشة السيارة وفتح مدير الملفات الأصلي لتثبيتها بلمسة واحدة من الشاشة.',
    recommendedFor: 'عند الرغبة في التثبيت اليدوي من شاشة السيارة',
    icon: <FolderOpen className="w-4 h-4 text-blue-400" />
  },
  {
    id: 'root_su_inject',
    name: 'الحقن المباشر بصلاحيات الروت المخفية (su / xbin)',
    badge: 'صلاحيات روت',
    badgeColor: 'bg-red-500/15 text-red-300 border-red-500/30',
    desc: 'فحص واستغلال ثنائيات su أو su daemon المتروكة في فريموير الشاشة للتثبيت بأعلى صلاحيات جذرية.',
    recommendedFor: 'الشاشات المروتة أو التي تحتوي su مهيأ مسبقاً',
